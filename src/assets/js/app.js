    ...
    languageDropdown: function () {
      ...
      for (var i = 0; i < getDropdownElement.length; i++) {
        getDropdownElement[i].addEventListener("click", function () {
          ...
          document
            .querySelectorAll(".more-dropdown .dropdown-toggle > img")[0]
            .setAttribute(
              "src",
              "assets/img/" + this.getAttribute("data-img-value") + ".png"
            );
        });
      }
    },
      ...
      for (var i = 0; i < getDropdownElement.length; i++) {
        getDropdownElement[i].addEventListener("click", function (e) {
          if (this.parentNode.classList.contains("dropdown-item-collapsable")) {
            ...
            $(".custom-dropdown-icon .dropdown-item-collapsable").toggleClass(
              "show"
            );
          }
